...
mod tests {
    ...
    fn test_move_from_only_moves_tracked_windows_on_source_workspace() {
        ...
        state.windows.push((300, 500, 500));
        ...
        let w100 = mock_window(100, true, false, source_ws);

        // Window 200: On Source WS (1) + NOT Tracked -> SHOULD IGNORE
        let w200 = mock_window(200, true, false, source_ws);

        // Window 300: On Wrong WS (99) + Tracked -> SHOULD IGNORE
        let w300 = mock_window(300, true, false, 99);

        // Window 400: On Target WS (2) + Focused
        let w400 = mock_window(400, true, true, target_ws);
